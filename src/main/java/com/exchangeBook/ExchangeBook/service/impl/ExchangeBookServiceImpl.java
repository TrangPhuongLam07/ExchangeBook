...
//    }
    ...
    @Override
    public boolean exchangeBook(EmailMessageRequest emailMessageRequest) throws MessagingException, UnsupportedEncodingException {
...
//            emailService.sendEmail(sender.getEmail(), emailMessageRequest.getTitle(),"Mail người muốn nhận sách: "+receiver.getEmail()+"\n"+emailMessageRequest.getContent() );
        emailSenderService.sendEmail(sender.getEmail(), emailMessageRequest.getTitle(), "Mail người muốn nhận sách: "+receiver.getEmail()+"\n"+emailMessageRequest.getContent()+" ---");
